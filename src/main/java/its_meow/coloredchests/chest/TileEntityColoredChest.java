...
public class TileEntityColoredChest extends TileEntityLockableLoot implements ITickable
{
	...
	public TileEntityColoredChest(Color colorIn) {
		this.color = colorIn;
	}
	...
	public void readFromNBT(NBTTagCompound compound)
	{
		...
		if(compound.hasKey("color")) {
			this.color = ColoredChestsMod.getColor(compound.getInteger("color"));
		} else {
	...
	public NBTTagCompound writeToNBT(NBTTagCompound compound)
	{
		...
		if(this.color != null) {
			compound.setInteger("color", ColoredChestsMod.getRGB(this.color));
		}
	...
	protected TileEntityColoredChest getAdjacentChest(EnumFacing side)
	{
		...
		if (this.isChestAt(blockpos))
		{
			...
			if (tileentity instanceof TileEntityColoredChest)
			{
				...
				if(ColoredChestsMod.doColorsMatch(tileentitychest.color, this.color)) {
	...
	public NonVanillaDoubleChestItemHandler doubleChestHandler;
	...
	public <T> T getCapability(net.minecraftforge.common.capabilities.Capability<T> capability, @Nullable net.minecraft.util.EnumFacing facing)
	{
		if (capability == net.minecraftforge.items.CapabilityItemHandler.ITEM_HANDLER_CAPABILITY)
		{
			if(doubleChestHandler == null || doubleChestHandler.needsRefresh())
				doubleChestHandler = NonVanillaDoubleChestItemHandler.get(this);
			if (doubleChestHandler != null && doubleChestHandler != NonVanillaDoubleChestItemHandler.NO_ADJACENT_CHESTS_INSTANCE)
